...
class AddCanonicalAccounts extends AbstractMigration
{
  public function up() {
    ...
    $this->table('users')
      ...
      ->insert(ray($keys, CG_INCOMING_BANK_UID, 0, t('bank-in'), t('Incoming bank'), 'cg@commongood.earth', '', 0, 0, 6)) 
      ->insert(ray($keys, CG_OUTGOING_BANK_UID, 0, t('bank-out'), t('Outgoing bank'), 'cg@commongood.earth', '', 0, 0, 6))
      ->save();
  }
