...
class CouponFixes extends AbstractMigration {
  ...
  public function up() {
    ...
    foreach (['users', 'x_users'] as $table) $this->execute(U_SQL);      
  }

  public function down() {
    $usersSql = str_replace("NOT NULL DEFAULT '0'", 'NULL DEFAULT NULL', U_SQL);
    foreach (['users', 'x_users'] as $table) $this->execute($usersSql);
  }
}
