...
class AddCanonicalAccounts extends AbstractMigration {
  ...
  public function up() {
    $this->table('users')
      ->insert(['uid'=>CG_ROUNDUPS_UID, 'community'=>0, 'name'=>'roundups', 'fullName'=>'Roundup Donations',
                'email'=>'cg@commongood.earth', 'zip'=>'', 'country'=>0, 'minimum'=>0, 'flags'=>6])
      ->insert(['uid'=>CG_CRUMBS_UID, 'community'=>0, 'name'=>'crumbs', 'fullName'=>'Crumb Donations',
                'email'=>'cg@commongood.earth', 'zip'=>'', 'country'=>0, 'minimum'=>0, 'flags'=>6])
