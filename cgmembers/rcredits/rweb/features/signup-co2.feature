Feature: A user opens a Common Good company account
AS a member
I WANT to open a Common Good company account
SO my company can accept Common Good payments
...
Scenario: A member registers a company
  When member ".ZZA" visits page "signup/personal=0&code=c0D3&helper=NEWZZA&flow=0&owner=1&employee=1"
